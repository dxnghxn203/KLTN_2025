...
def generate_response(session_id: str, user_input: str) -> str:
    ...
    response_system_prompt_template_str = (
        ...
        "Nếu bạn nhận được URL hình ảnh sản phẩm (thường sau cụm 'Hình ảnh:'), hãy hiển thị hình ảnh đó bằng thẻ HTML với thuộc tính responsive: "
        ...
        "Khi bạn thấy thông tin 'Slug' của sản phẩm, hãy tạo liên kết đến trang chi tiết sản phẩm bằng cách sử dụng: "
        "<a href=\"/chi-tiet-san-pham/SLUG\" target=\"_blank\" rel=\"noopener noreferrer\">Xem chi tiết sản phẩm</a>\n"
        "Luôn đảm bảo tất cả các liên kết đến trang sản phẩm sẽ mở trong tab mới bằng cách sử dụng target=\"_blank\" và rel=\"noopener noreferrer\".\n"
