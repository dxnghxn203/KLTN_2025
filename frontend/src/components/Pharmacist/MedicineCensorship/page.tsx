...
const MedicineCensorshipList = () => {
    ...
    const [prescriptionFilter, setPrescriptionFilter] = useState<boolean | string>("");
    ...
    const [selectedProductApproved, setSelectedProductApproved] = useState<any>(null);
    ...
    const handleFilterChange = (filters: any) => {
        ...
        if (filters.prescription !== '') {
            newActiveFilters.push(`Kê toa: ${filters.prescription === true ? "Có" : "Không"}`);
        }
        if (filters.category) {
            ...
            <div className="space-y-6">
                                    ...
                                    >
                                        <td className="py-4 px-4 text-center">
                                            {product.images_primary ? (
                                                ...
                                                <div
                                                    className="h-12 w-12 bg-gray-200 flex items-center justify-center rounded mx-auto">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-4">
                    <div className="text-sm text-gray-600">
                        Hiển
                        thị {filteredProducts.length > 0 ? indexOfFirstProduct + 1 : 0} - {Math.min(indexOfLastProduct, filteredProducts.length)} trong
