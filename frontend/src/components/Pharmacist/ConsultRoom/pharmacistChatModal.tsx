...
export const PharmacistChatModal = ({isOpen, onClose, conversation}: PharmacistChatModalProps) => {
        ...
        <>
            ...
            >
                <div className="min-h-screen px-4 text-center">
                    ...
                    <Dialog.Panel
                        className="inline-block w-full max-w-2xl h-[600px] p-0 my-8 text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                        <div className="flex items-center justify-between px-6 py-4 border-b">
                            <div>
                                <Dialog.Title className="text-lg font-semibold text-gray-900">
                                    {conversation?.guest_name ? `Chat với ${conversation.guest_name}` : 'Phòng chat'}
                                </Dialog.Title>
                            ...
                            {isLoading ? (
                                <div className="flex-1 flex items-center justify-center">
                                    <div className="flex flex-col items-center space-y-2">
                                        ...
                                        <p className="text-sm text-gray-500">Đang tiếp nhận cuộc hội thoại...</p>
                                    </div>
                                </div>
                            ) : error ? (
