...
const OutOfStock = ({
  ...
  console.log("OutOfStock products:", products);
  ...
  const renderProductItem = (
    ...
    >
      ...
      <div className="w-[15%] text-center text-gray-700">{product?.unit}</div>
    </div>
  );

  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center overflow-auto p-4">
      <div className="bg-white rounded-xl w-full max-w-xl shadow-xl relative my-10 transition-all duration-300">
