...
const PrescriptionForm = () => {
    ...
    const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        const validImages = files.filter((file) => {
            const isValidType = ["image/jpeg", "image/png", "image/jpg", "application/pdf"].includes(
                file.type
            );
                  ...
                  focus:border-[#0053E2] focus:ring-1 focus:ring-[#0053E2] placeholder:font-normal placeholder:text-[14px]"
                        ...
                        {showUploadBox && (
                            <div className="bg-[#F5F7F9] py-4 px-4 rounded-xl space-y-2">
                                ...
                                <div
                                    className="border border-dashed border-[#0053E2] bg-[#F0F9FF] rounded-xl px-4 py-6 space-y-4">
                    ...
                    <div className="flex w-full flex-col space-y-4">
                            ...
                            <div className="relative pl-10">
                                ...
                                <div className="space-y-6">
                                    <div className="relative">
                                        <div
                                            className="absolute -left-[40px] top-0 w-6 h-6 bg-[#9BB8E3] text-white rounded-full flex items-center justify-center text-sm font-bold">
                                            1
                                        </div>
                                        <p>
                        ...
                        <div
                            className="bg-[#F5F7F9] p-4 rounded-xl w-full text-sm items-center flex justify-center space-x-2">
                            <Link
