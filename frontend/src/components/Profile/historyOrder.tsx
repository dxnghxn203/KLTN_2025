          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 border rounded-lg">
              ...
              <div className="space-y-1">
                ...
                <p>
                  <span className="font-medium text-gray-600">Tiền hàng:</span>{" "}
                  {order.product_fee?.toLocaleString("vi-VN")}đ
                </p>
                <p>
                  <span className="font-medium text-gray-600">Phí ship:</span>{" "}
                ...
                <p>
                  <span className="font-medium text-gray-600">Cân nặng:</span>{" "}
                  {order.weight} kg
                </p>
              </div>
            </div>
            ...
            <ul className="space-y-4">
              {order.product.map((product: any) => (
                ...
                >
                  ...
                  <p className="font-medium ml-4 flex-shrink-0">
                ...
                <div className="border-b last:border-0 pb-3">
                  <div className="flex justify-between items-center">
                    ...
                    {(() => {
                      ...
                      return (
                        <span
                          className={`ml-2 inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${statusInfo.colors.bg} ${statusInfo.colors.text}`}
                        >
                          <span className={`mr-1.5 ${statusInfo.colors.text}`}>
                            ●
                          </span>
                          {statusInfo.displayName}
                        </span>
