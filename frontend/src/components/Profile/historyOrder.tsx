            ...
            <div className="mt-4 flex space-x-4 border-b border-gray-300 overflow-x-auto">
                {tabs.map((tab) => (
                    ...
                    >
                        ...
                        {tab.id !== "all" && (
                            <span
                                className="ml-2 w-6 h-6 bg-blue-100 text-blue-600 text-xs font-semibold rounded-full flex items-center justify-center">
                        ...
                        {`${order.pick_to.address.address}, ${order.pick_to.address.ward}, ${order.pick_to.address.district}, ${order.pick_to.address.province}`}
                          ...
                          {order?.estimated_total_fee?.toLocaleString("vi-VN")}đ
                                                ...
                                                <div className="flex items-center">
                                                    {order?.payment_type === "COD" ? (
                                                        <>
                                                            ...
                                                            <span
                                                                className="ml-1.5 px-2.5 py-1 bg-amber-100 text-amber-700 rounded-full text-sm font-medium">
                                ...
                                Phương thức:{" "}
                                                            ...
                                                            <span
                                                                className="ml-1.5 px-2.5 py-1 bg-green-100 text-green-700 rounded-md text-sm font-medium">
                                Thanh toán trước
                              </span>
                                                        </>
                                                    )}
