...
const VoucherDialog: React.FC<DeleteDialogProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div
                className="bg-white w-full max-w-3xl max-h-[90vh] rounded-lg flex flex-col items-center relative overflow-hidden px-8 py-6">
                <button
                    onClick={onClose}
                            ...
                            (voucher: any, index: number) =>
                                voucher.voucher_type === "delivery" && (
                                    ...
                                    >
                                        ...
                                        <div className="flex">
                                            <div
                                                className="w-24 bg-[#26A999] text-white text-center font-bold py-6 rounded-l-xl p-4 rang-cua-left">
                                                FREE
                                                <br/>
                                                SHIP
                            ...
                            (voucher: any, index: number) =>
                                voucher.voucher_type === "order" && (
                                    ...
                                    >
                                        ...
                                        <div className="flex">
                                            <div
                                                className="w-24 bg-[#EA4B2A] text-white text-center font-bold py-6 rounded-l-xl p-4 rang-cua-left">
                                                ĐƠN
                                                <br/>
                                                HÀNG
                                                <p className="text-xs mt-2">Toàn Ngành Hàng</p>
                ...
                <div className="flex justify-center mt-6 w-full">
                    <button
                        className="bg-[#0053E2] text-white font-semibold w-full max-w-3xl py-3 rounded-full hover:bg-[#002E99]">
                        Xác nhận
                    </button>
                </div>
            </div>
