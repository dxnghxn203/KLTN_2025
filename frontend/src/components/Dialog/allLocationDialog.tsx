...
const AllLocationDialog = ({ allLocation, closeDialog, getLocation, selectedLocation, setSelectedLocation }: {
    allLocation: any
    closeDialog: any
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="bg-white rounded-lg w-[640px] shadow-lg overflow-hidden relative h-[600px]">
                ...
                <div className="relative w-full h-full overflow-hidden">
                    <div
                        className={`absolute top-0 left-0 w-full h-full transition-all duration-500 transform ${(onAddLocation || updateLocation) ? "-translate-x-full" : "translate-x-0"
                            }`}
                    >
                        <ListLocation
                    ...
                    <div
                        className={`absolute top-0 left-0 w-full h-full transition-all duration-500 transform ${(onAddLocation || updateLocation) ? "translate-x-0" : "translate-x-full"
                            }`}
                    >
                        <button
                            onClick={() => {
