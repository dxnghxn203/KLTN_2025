                ...
                <header className="w-full px-4 md:px-8 transition-all duration-300">
                    <div className="relative flex items-center justify-between h-[72px] sm:h-[72px] px-4">
                        ...
                        <div className="flex-grow max-w-[580px]" ref={searchRef}>
                            <div className="flex items-center bg-white rounded-lg px-4 py-2 ">
                                ...
                                <div className="relative mx-2">
                                    ...
                                    >
                                        ...
                                        <span
                                            className="absolute -top-1 -right-1 w-2 h-2 bg-blue-500 rounded-full animate-ping"></span>
                                    </button>
                                    ...
                                    {showScanTooltip && (
                                        ...
                                        >
                                            <span className="font-medium">Chụp hình thuốc</span> để tìm kiếm
                                            <div
                                                className="absolute -top-1 left-1/2 tooltip-arrow w-2 h-2 bg-blue-700 rotate-45 border-t border-l border-blue-400"></div>
                                        </div>
                                    )}
                                </div>
                            ...
                            {showSuggestions && (
                                <div
                                    className="absolute bg-white shadow-lg rounded-lg z-50 p-4 w-full max-w-[580px] mt-1">
                                    <div>
                            ...
                            {searchResultProduct && searchResult !== null && !isLoading && (
                                <div
                                    className="absolute bg-white shadow-lg rounded-lg z-50 w-full max-w-[580px] overflow-y-auto max-h-[500px] hide-scrollbar mt-1 ">
                                                        ...
                                                        >
                                                            {cart &&
                                                                cart.map((item: any, index: any) => (
                                                                    ...
                                                                    >
                                                                        <div
                                                                            className="w-14 h-14 flex-shrink-0 bg-gray-100 rounded overflow-hidden flex items-center justify-center">
                                                                            <Image
                                                                        ...
                                                                        <div
                                                                            className="ml-3 flex-1 flex flex-col justify-between">
                                                                            <div>
