        ...
        return (
            <>
                            ...
                            {product?.product?.prices && product?.product?.prices.map((priceOption: any) => (
                                <div
                                    ...
                                    className={clsx(
                                        ...
                                        priceOption.price_id === price_id ? "bg-blue-50 text-blue-700" : "text-gray-900"
                                    )}
                                    onClick={() => {
                                ...
                                >
                                    {priceOption.unit} - {priceOption.price.toLocaleString("vi-VN")}đ
                                </div>
                            ))}
                        </div>
                    )}
                ...
                <div className="w-[12%] text-center font-semibold text-[#0053E2]">
                    {calculateTotalPrice(price?.price, product.quantity).toLocaleString("vi-VN")}đ
                </div>
            </>
        );
    };
