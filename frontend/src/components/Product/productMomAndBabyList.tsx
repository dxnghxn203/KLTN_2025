...
import ProductMomAndBabyCard from "./productMomAndBabyCard";
...
const ProductMomAndBabyList: React.FC = () => {
            ...
            <>
              <div className="grid grid-cols-5 gap-4 max-md:grid-cols-1">
                {sortedAndFilteredProducts.map((product, index) => (
                  <ProductMomAndBabyCard key={index} {...product} />
                ))}
              </div>
              {showAll && (
...
export default ProductMomAndBabyList;
