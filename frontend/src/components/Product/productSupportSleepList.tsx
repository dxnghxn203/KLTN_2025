...
import ProductSupportSleepCard from "./productSupportSleepCard";
...
const ProductSupportSleepList: React.FC = () => {
            ...
            <>
              <div className="grid grid-cols-5 gap-4 max-md:grid-cols-1">
                {sortedAndFilteredProducts.map((product, index) => (
                  <ProductSupportSleepCard key={index} {...product} />
                ))}
              </div>
              {showAll && (
...
export default ProductSupportSleepList;
