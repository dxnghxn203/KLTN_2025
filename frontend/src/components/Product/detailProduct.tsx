        ...
        <div className="w-full">
            <div className="bg-[#F5F7F9] px-5 rounded-lg w-full">
                ...
                {product?.brand}
                        ...
                        <div
                            className="flex flex-col sm:flex-row items-start sm:items-center sm:space-x-2 space-y-1 sm:space-y-0 text-gray-600 text-sm">
                ...
                {Number(product?.rating).toFixed(1)}
                  ...
                  <FaStar className="text-[#FFD700] text-lg ml-2"/>
                    ...
                    <span
                        className="px-2 py-2 text-sm font-medium text-black bg-amber-300 rounded-lg flex items-center justify-center">
                      Giảm {selectedPrice.discount}%
                    </span>
                                        {selectedPrice?.original_price && (
                                            <span
                                                className="text-2xl font-bold text-zinc-400 line-through flex items-center">
