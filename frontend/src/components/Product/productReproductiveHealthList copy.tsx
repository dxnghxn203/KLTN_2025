...
import ProductReproductiveHealthCard from "./productReproductiveHealthCard";
...
const ProductReproductiveHealthList: React.FC = () => {
            ...
            <>
              <div className="grid grid-cols-5 gap-4 max-md:grid-cols-1">
                {sortedAndFilteredProducts.map((product, index) => (
                  <ProductReproductiveHealthCard key={index} {...product} />
                ))}
              </div>
              {showAll && (
...
export default ProductReproductiveHealthList;
