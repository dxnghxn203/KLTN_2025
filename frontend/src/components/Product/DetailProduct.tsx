...
const ProductDetail = ({ product }: ProductDetailProps) => {
    ...
    const selectedPrice = product.prices.find(price => price.unit === selectedUnit) || product.prices[0];
            ...
            <div className="grid grid-cols-2 gap-6">
                <div className="flex flex-col items-center mt-12">
                    <div className="relative w-96 h-96 overflow-hidden">
                        ...
                        >
                            <Image
                                src={selectedImage == 0 ? product.imagesPrimary : product.images[selectedImage - 1].url}
                                alt={product.name}
                                fill
                    ...
                    <div className="flex space-x-2 mt-4">
                        ...
                        {product.images.slice(0, 2).map((img, index) => (
                            <div
                                key={img.id}
                                className={`w-28 h-28 rounded-lg overflow-hidden border flex items-center justify-center ${
                                    selectedImage === index + 1 ? "border-[#002E99]" : "border-gray-300"
                                }`}
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-4 items-stretch">
                        ...
                        <div className="col-span-2 flex flex-col justify-between">
                            <div className="flex flex-col space-y-6 flex-1">
                                <p className="text-[#0053E2] font-semibold">{product.category.name}</p>
                                <p>Viên nang cứng</p>
                                <p>Hộp 10 Viên</p>
                                <p>Việt Nam</p>
