...
import ProductPersonalCareCard from "./productPersonalCareCard";
...
const ProductPersonalCareList: React.FC = () => {
            ...
            <>
              <div className="grid grid-cols-5 gap-4 max-md:grid-cols-1">
                {sortedAndFilteredProducts.map((product, index) => (
                  <ProductPersonalCareCard key={index} {...product} />
                ))}
              </div>
              {showAll && (
...
export default ProductPersonalCareList;
