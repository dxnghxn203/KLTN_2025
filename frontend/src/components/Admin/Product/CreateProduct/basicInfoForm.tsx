    ...
    return (
        <div className="mb-4">
            ...
            <div className="grid grid-cols-2 gap-4 mb-2">
              ...
              ${formData.is_approved ? "text-green-600" : "text-red-600"}
            `}
                        value={formData.is_approved ? "Duyệt" : "TỪ CHỐI"}
                        disabled={true}
                    />
            ...
            {formData.rejected_note && formData.is_approved === false && (
            ...
            <div className="flex grid grid-cols-2 gap-4">
                <div className="flex items-center gap-2">
                    <input
                        ...
                        onChange={(e) => updateFormData({prescription_required: e.target.checked})}
