                ...
                <div className="overflow-x-auto">
                    <table className="w-full table-auto border-collapse">
                        <thead className="text-left text-[#1E4DB7] text-sm font-bold border-b border-gray-200 bg-[#F0F3FD]">
                            <tr>
                                <th className="py-4 px-4 w-[60px]">Hình ảnh</th>
                                <th className="py-4 px-6 w-[280px]">Tên sản phẩm</th>
                                <th className="py-4 px-4 w-[120px] text-center">Mã sản phẩm</th>
                                <th className="py-4 px-4 w-[100px] text-center">Kho</th>
                                <th className="py-4 px-4 w-[120px] text-center">Giá</th>
                                <th className="py-4 px-4 w-[180px] text-center">Danh mục</th>
                                <th className="py-4 px-4 w-[100px] text-center">Xuất xứ</th>
                            ...
                            {currentProducts && currentProducts.length > 0 ? (
                                currentProducts.map((product: any, index: number) => (
                                    <tr
                                        ...
                                        className={`text-sm hover:bg-gray-50 transition ${index !== currentProducts.length - 1
                                                ? "border-b border-gray-200"
                                                : ""
                                            }`}
                                    >
                                        <td className="py-4 px-4 w-[60px] text-center">
                                        ...
                                        <td className="py-4 px-6 w-[280px] text-left leading-5">
                                        ...
                                        <td className="p-4 w-[100px] text-center font-medium">
