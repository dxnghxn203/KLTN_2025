...
import CategoryReproductiveHealth from "@/components/Category/categoryReproductiveHealth";
    ...
    <div className="flex flex-col pb-12 bg-white pt-[80px]">
      ...
      <main className="flex flex-col pt-14">
        <div className="text-sm text-[#0053E2] px-5">
          ...
          {pathname === "/reproductive-health" && (
            <span className="text-gray-500"> / Sức khỏe sinh sản</span>
          )}
        </div>
        <div className="text-2xl font-bold py-4 px-6">Sức khỏe sinh sản</div>
        <CategoryReproductiveHealth />
      </main>
