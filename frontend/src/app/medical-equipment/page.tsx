...
import CategoryMedicalEquipment from "@/components/Category/categoryMedicalEquipment";
      ...
      <main className="flex flex-col pt-14">
        <div className="text-sm text-[#0053E2] px-5">
          ...
          {pathname === "/medical-equipment" && (
            <span className="text-gray-500"> / Thiết bị y tế</span>
          )}
        </div>
        <div className="text-2xl font-bold py-4 px-6">Thiết bị y tế</div>
